...
# --- Функция поиска ресурсов (картинок) внутри EXE ---
...
def monitor_loop():
    ...
    while RUNNING:
        ...
        start = int(settings.get("start_hour", 9))
        end = int(settings.get("end_hour", 14))
...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.btn_info = ctk.CTkButton(self, text="О программе", 
                                      ...
                                      font=("Segoe UI", 12),
                                      height=30)
        self.btn_info.pack(side="bottom", pady=20)
    ...
    def on_save_start(self):
        new_settings = {
            ...
            "start_hour": int(self.entry_start.get()),
